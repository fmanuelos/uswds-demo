...
- Install components with short commands: `npx shadcn@latest add @uswds-demo/buttons`
...
```bash
npx shadcn@latest add https://fmanuelos.github.io/uswds-demo/r/nextjs-styles.json
```
