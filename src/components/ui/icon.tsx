...
const iconPaths: Record<IconType, React.ReactNode> = {
  ...
  unfold_less: (
    <>
      <path d="m7.41 18.59 1.41 1.41 3.17-3.17 3.17 3.17 1.41-1.41L12 14.83l-4.59 3.76zm9.18-13.18L15.18 4 12 7.17 8.82 4 7.41 5.41 12 9.17l4.59-4.76z"></path>
    </>
  ),
  unfold_more: (
    <>
      <path d="m12 5.83 2.46 2.46 1.41-1.41L12 3.01 8.13 6.88l1.41 1.41L12 5.83zm0 12.34-2.46-2.46-1.41 1.41L12 20.99l3.87-3.87-1.41-1.41L12 18.17z"></path>
    </>
  ),
  ...
  hourglass_empty: (
    <>
      <path d="M6 2v6h.01L6 8.01 10 12l-4 4 .01.01H6V22h12v-5.99h-.01L18 16l-4-4 4-3.99-.01-.01H18V2H6zm10 14.5V20H8v-3.5l4-4 4 4zm-4-5-4-4V4h8v3.5l-4 4z"></path>
    </>
  ),
  schedule: (
    <>
  ...
  do_not_touch: (
    <>
      <path d="M13 10.17 9.83 7h3.92c.65 0 1.25.47 1.25 1.11v.06c0 .41.34.75.75.75s.75-.34.75-.75v-.06C16.5 6.57 15.38 5.5 14 5.5h-3.17L7.5 2.17 6.09 3.59 2.59 7.09 1.5 8.17l1.41 1.41 12.92 12.92 1.41-1.41-1.83-1.83v.03c0 .63-.58 1.21-1.21 1.21H8c-1.43 0-2.5-1.16-2.5-2.5V12c0-.46.1-.9.26-1.3L2.59 7.09 13 17.5v.17zm-2.2 9.1c.89 0 1.62-.71 1.62-1.59l-4.88-4.88c-.08.17-.15.34-.15.54v5.93h3.41z"></path>
    </>
  ),
  drag_handle: (
    <>
  ...
  instagram: (
    <>
      <path d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 1 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4H7.6m9.65 1.5a1.25 1.25 0 0 1 1.25 1.25A1.25 1.25 0 0 1 17.25 8 1.25 1.25 0 0 1 16 6.75a1.25 1.25 0 0 1 1.25-1.25M12 7a5 5 0 0 1 5 5 5 5 0 0 1-5 5 5 5 0 0 1-5-5 5 5 0 0 1 5-5m0 2a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3z"></path>
    </>
  ),
  linkedin: (
    <>
      <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.40 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"></path>
    </>
  ),
  twitter: (
    <>
      <path d="M22.46 6c-.85.38-1.78.64-2.75.76a4.78 4.78 0 0 0 2.1-2.66c-.92.55-1.95.95-3.04 1.16A4.75 4.75 0 0 0 15.31 4c-2.63 0-4.76 2.13-4.76 4.76 0 .37.04.74.12 1.08-3.96-.2-7.47-2.1-9.81-4.98a4.75 4.75 0 0 0 1.47 6.35 4.72 4.72 0 0 1-2.16-.6v.06c0 2.31 1.64 4.23 3.82 4.67a4.76 4.76 0 0 1-2.15.08 4.76 4.76 0 0 0 4.45 3.3A9.54 9.54 0 0 1 .97 20.5 13.46 13.46 0 0 0 8.29 23c8.75 0 13.54-7.25 13.54-13.54 0-.21 0-.41-.01-.61A9.63 9.63 0 0 0 24 6.39a9.45 9.45 0 0 1-2.54.7"></path>
    </>
  ),
  youtube: (
    <>
  ...
  flooding: (
    <>
      <path d="M18.67 19c-1.95 0-2.09 1-3.33 1-1.19 0-1.42-1-3.33-1-1.95 0-2.1 1-3.34 1-1.24 0-1.38-1-3.33-1-1.95 0-2.1 1-3.34 1v2c1.95 0 2.11-1 3.34-1 1.24 0 1.38 1 3.33 1 1.95 0 2.1-1 3.34-1 1.22 0 1.4 1 3.33 1 1.93 0 2.1-1 3.33-1 1.22 0 1.4 1 3.33 1v-2c-1.24 0-1.38-1-3.33-1zM18.67 16c-1.95 0-2.09 1-3.33 1-1.19 0-1.42-1-3.33-1-1.95 0-2.1 1-3.34 1-1.24 0-1.38-1-3.33-1-1.95 0-2.1 1-3.34 1v2c1.95 0 2.11-1 3.34-1 1.24 0 1.38 1 3.33 1 1.95 0 2.1-1 3.34-1 1.22 0 1.4 1 3.33 1 1.93 0 2.1-1 3.33-1 1.22 0 1.4 1 3.33 1v-2c-1.24 0-1.38-1-3.33-1zM6 6v5H4V6c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2v3h-2V6H6zm7 7h-2v-2h2v2z"></path>
    </>
  ),
  hurricane: (
    <>
  ...
  rain: (
    <>
      <path d="M9.25 18a.25.25 0 0 1-.25-.25v-3.5a.25.25 0 0 1 .5 0v3.5a.25.25 0 0 1-.25.25zm3 0a.25.25 0 0 1-.25-.25v-3.5a.25.25 0 0 1 .5 0v3.5a.25.25 0 0 1-.25.25zm3 0a.25.25 0 0 1-.25-.25v-3.5a.25.25 0 0 1 .5 0v3.5a.25.25 0 0 1-.25.25zm4.52-10.81C19.02 5.09 16.7 4 13.95 4c-2.74 0-5.09 1.57-6.26 3.86-.84-.14-1.71-.06-2.5.22C3 8.79 1 11.08 1 13.73c0 2.49 1.67 4.59 3.95 5.24.35.1.71-.08.81-.43.1-.35-.08-.71-.43-.81C3.55 17.22 2 15.61 2 13.73c0-2.12 1.42-3.94 3.39-4.52 1.23-.37 2.55-.14 3.62.63.32.23.76.17 1.02-.15C11.05 8.32 12.41 7 13.95 7c2.29 0 4.17 1.7 4.49 3.91.04.27.23.49.49.57 1.31.4 2.26 1.57 2.26 2.99 0 1.67-1.29 3.07-2.96 3.19-.35.03-.62.33-.59.68.03.35.33.62.68.59C20.38 18.79 22 17.04 22 14.95c0-1.85-1.19-3.44-2.87-4.07-.19-1.09-.65-2.06-1.36-2.8z"></path>
    </>
  ),
  severe_weather: (
    <>
      <path d="M14.5 11 10 1 5.5 11H1l8.5 6L6 23l4-4 4 4-3.5-6L19 11h-4.5zM12 14.5 9.5 13 12 8l2.5 5-2.5 1.5z"></path>
    </>
  ),
  snow: (
    <>
  ...
  tornado: (
    <>
      <path d="M1 2h22v2H1V2zm4 4h16v2H5V6zm4 4h10v2H9v-2zm2 4h6v2h-6v-2zm-2 4h10v2H9v-2z"></path>
    </>
  ),
