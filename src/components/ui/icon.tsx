...
const iconPaths: Record<IconType, React.ReactNode> = {
  ...
  notifications_off: (
    <>
      <path d="M20 18.69 7.84 6.14 5.27 3.49 4 4.76l2.8 2.8v.01c-.52.99-.8 2.16-.8 3.42v5l-2 2v1h13.73l2 2L21 19.72l-1-1.03zM12 22c1.11 0 2-.89 2-2h-4c0 1.11.89 2 2 2zm6-7.32V11c0-3.08-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68c-.24.06-.47.15-.69.23l1.64 1.64c.68-.15 1.39.09 1.95.65l1.42-1.42c-.11-.21-.23-.40-.35-.59L18 14.68z"></path>
    </>
  ),
  priority_high: (
    <>
  ...
  fingerprint: (
    <>
      <path d="M17.81 4.47c-.08 0-.16-.02-.23-.06C15.66 3.42 14 3 12.01 3c-1.98 0-3.86.47-5.57 1.41-.24.13-.54.04-.68-.2a.506.506 0 0 1 .2-.68C7.82 2.52 9.86 2 12.01 2c2.13 0 3.99.47 6.03 1.52.25.13.34.43.21.67a.49.49 0 0 1-.44.28zM3.5 9.72a.499.499 0 0 1-.41-.79c.99-1.4 2.25-2.5 3.75-3.27C9.98 4.04 14 4.03 17.15 5.65c1.5.77 2.76 1.86 3.75 3.25.14.17.17.42.06.61a.49.49 0 0 1-.67.17c-.19-.1-.32-.28-.32-.5 0-.12.04-.25.11-.35-.9-1.26-2.06-2.25-3.44-2.95C14.04 4.65 10.34 4.66 7.73 5.88c-1.38.7-2.54 1.69-3.44 2.95-.08.1-.11.23-.11.35 0 .08-.03.16-.08.23-.1.14-.26.22-.43.22-.07-.01-.14-.02-.17-.05zM9.75 21.79a.507.507 0 0 1-.5-.5c0-.28.22-.5.5-.5 1.02 0 1.93-.87 1.93-1.85V15.8c0-1.34-1.08-2.43-2.43-2.43S6.82 14.46 6.82 15.8v1.44c0 .28-.22.5-.5.5s-.5-.22-.5-.5V15.8c0-1.89 1.54-3.43 3.43-3.43s3.43 1.54 3.43 3.43v3.14c0 1.54-1.37 2.85-2.93 2.85zm-.83-7.44c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25z"></path>
    </>
  ),
  identification: (
    <>
