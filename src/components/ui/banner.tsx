...
const Banner = React.forwardRef<HTMLElement, BannerProps>(
  ({ variant = "gov", className, defaultOpen = false, ...props }, ref) => {
    ...
    return (
      ...
      >
        {/* Header */}
        <header className="flex text-xs gap-2 md:items-center pl-4 pr-12 md:pr-4 md:px-8 py-2 md:py-1 mx-auto max-w-5xl min-h-12 md:min-h-0 leading-tight md:leading-none relative">
          ...
          <div className="md:flex gap-2 items-center">
            ...
            <button
              ...
              onClick={toggleOpen}
              className="text-blue-60v group-data-[open]:block focus:outline-none md:focus:outline md:focus:outline-4 md:focus:outline-blue-40v cursor-pointer group after:absolute md:after:relative after:inset-0 md:inset-auto focus:after:outline md:focus:after:outline-none focus:after:outline-4 focus:after:outline-blue-40v"
            >
        ...
        <div
          hidden={!isOpen}
          className="py-6 px-6 grid md:grid-cols-2 gap-6 mx-auto max-w-5xl"
        >
