    ...
    <div className="py-8 px-4 mx-auto max-w-screen-desktop font-public-sans">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl mb-6 max-w-prose">
          A collection of shadcn/ui-style components built with the U.S. Web Design System (USWDS) 
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather">Accordion</h2>
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xl font-bold mb-4">FAQ - Multiple Selection</h3>
            <Accordion type="multiple" className="w-full space-y-2">
              <AccordionItem value="faq-1">
                <AccordionTrigger>How do I apply for benefits?</AccordionTrigger>
                <AccordionContent>
                  <p className="leading-normal max-w-prose">
                    You can apply for benefits online through our secure portal. The application process typically takes 15-20 minutes to complete. You'll need to provide personal information, employment history, and supporting documentation.
                  </p>
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="faq-2">
                ...
                <AccordionContent>
                  <p className="leading-normal max-w-prose">
                    Required documents include a valid government-issued photo ID, Social Security card, proof of income for the last 6 months, and any relevant medical records or disability documentation.
                  </p>
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="faq-3">
                ...
                <AccordionContent>
                  <p className="leading-normal max-w-prose">
                    Most applications are processed within 30-45 business days. You'll receive email notifications at key milestones, and you can check your application status online at any time using your reference number.
                  </p>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
      ...
      {/* Alert Examples */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather">Alerts</h2>
        <div className="space-y-4">
          ...
          <Alert variant="info" showIcon={true}>
            ...
            <AlertDescription>
              This is an informational message to help guide you through the process.
            </AlertDescription>
          </Alert>
        </div>
      </section>
      ...
      {/* Dialog Examples */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather">Dialog</h2>
        <div className="space-y-8">
          <div>
              ...
              <DialogContent>
                ...
                <DialogFooter>
                  <ul className="flex flex-col sm:flex-row gap-2 w-full">
                    ...
                    <li className="flex">
                      <Button variant="danger" className="flex-1">Delete Account</Button>
                    </li>
                  </ul>
                </DialogFooter>
              </DialogContent>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4">Session Timeout Dialog</h3>
            <Dialog>
              <DialogTrigger asChild>
              ...
              <DialogContent>
                ...
                <DialogFooter>
                  <ul className="flex flex-col sm:flex-row gap-2 w-full">
                    <li className="flex">
                      <DialogClose asChild>
                        <Button variant="primary" className="flex-1">Yes, stay signed in</Button>
                      </DialogClose>
                    </li>
                    <li className="flex">
                      <DialogClose asChild>
                        <Button variant="link" className="flex-1">Sign out</Button>
                      </DialogClose>
                    </li>
                  </ul>
                </DialogFooter>
      ...
      {/* Button Examples */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather">Buttons</h2>
        ...
        <div className="grid grid-cols-1 tablet:grid-cols-2 desktop:grid-cols-3 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Learn about our government services and how they can help you.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p>
                Access important information, forms, and resources all in one place.
                Our services are designed to be accessible and easy to use.
              </p>
            </CardContent>
            <CardFooter>
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Complete your application online with our secure and user-friendly forms.
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Our support team is available to help you navigate our services
      ...
      {/* Badge Examples */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather">Badges</h2>
        <div className="space-y-4">
          <div>
      ...
      {/* Typography Examples */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather">Typography</h2>
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-bold mb-4">Font Families</h3>
            <div className="space-y-3">
              <p className="font-public-sans text-lg">
                <span className="font-bold">Public Sans:</span> The default font for body text and UI elements.
              </p>
              <p className="font-source-sans text-lg">
                <span className="font-bold">Source Sans:</span> Alternative sans-serif font for variety.
              </p>
              <p className="font-open-sans text-lg">
                <span className="font-bold">Open Sans:</span> Another clean sans-serif option.
              </p>
              <p className="font-merriweather text-lg">
                <span className="font-bold">Merriweather:</span> Serif font perfect for headings and emphasis.
              </p>
              <p className="font-roboto-mono text-lg">
                <span className="font-bold">Roboto Mono:</span> Monospace font for code and technical content.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Table Examples */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather text-gray-90">Tables</h2>
        
        <div className="space-y-8">
          {/* Basic Table */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-gray-80">Government Services Overview</h3>
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell className="font-roboto-mono">SVC-001</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-roboto-mono">SVC-002</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-roboto-mono">SVC-003</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-roboto-mono">SVC-004</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-roboto-mono">SVC-005</TableCell>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 text-gray-80">Recent Applications (Striped)</h3>
            <Table>
              <TableCaption>Recent Applications with Striped Rows</TableCaption>
              <TableHeader>
                <TableRow>
              ...
              <TableBody striped>
                <TableRow>
                  <TableCell className="font-roboto-mono">#APP-2024-001</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-roboto-mono">#APP-2024-002</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-roboto-mono">#APP-2024-003</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-roboto-mono">#APP-2024-004</TableCell>
      ...
      {/* Pagination Examples */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather">Pagination</h2>
        <div className="space-y-8">
          <div>
            ...
            <Pagination>
              <PaginationContent>
                ...
                <PaginationItem>
                  <PaginationLink href="#" isLast>8</PaginationLink>
                </PaginationItem>
                <PaginationNext href="#" />
              </PaginationContent>
            </Pagination>
      ...
      {/* Checkbox Examples */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather">Checkboxes</h2>
        <div className="space-y-8">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <Label htmlFor="notifications">Enable notifications (disabled)</Label>
              </div>
            </div>
          </div>

          <div>
            <h3 className="text-xl font-bold mb-4">Historical Figures Selection</h3>
            <fieldset className="max-w-xs">
              <legend className="leading-snug mb-3 font-bold text-base">Select any historical figure</legend>
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  <Checkbox id="sojourner" />
                  <Label htmlFor="sojourner" className="cursor-pointer">Sojourner Truth</Label>
                </div>
                <div className="flex items-center space-x-3">
                  <Checkbox id="frederick" defaultChecked />
                  <Label htmlFor="frederick" className="cursor-pointer">Frederick Douglass</Label>
                </div>
                <div className="flex items-center space-x-3">
                  <Checkbox id="booker" />
                  <Label htmlFor="booker" className="cursor-pointer">Booker T. Washington</Label>
                </div>
                <div className="flex items-center space-x-3">
                  <Checkbox id="george" defaultChecked />
                  <Label htmlFor="george" className="cursor-pointer">George Washington Carver</Label>
                </div>
              </div>
            </fieldset>
          </div>
          ...
          <div>
            ...
            <fieldset className="max-w-md">
              <legend className="leading-snug mb-3 font-bold text-base">Select government services</legend>
              <div className="space-y-2">
                <Label 
                  htmlFor="passport" 
                ...
                <Label 
                  ...
                  className="flex relative z-0 px-4 py-4 cursor-pointer rounded border-2 border-gray-20 bg-white hover:border-blue-60 has-[:checked]:border-blue-60 has-[:checked]:bg-blue-60/10"
                >
                  <Checkbox id="social-security" className="mt-0.5" defaultChecked />
                  <div className="pl-3">
                    <div className="font-medium">Social Security Benefits</div>
                    <div className="text-sm text-gray-60 mt-1">
                ...
                >
                  ...
                  <div className="pl-3">
                    ...
                    <div className="text-sm text-gray-60 mt-1">
                      Access healthcare, disability compensation, and education benefits
                    </div>
                  </div>
                </Label>
                ...
                >
                  ...
                  <div className="pl-3">
                    <div className="font-medium">Medicare Enrollment (Unavailable)</div>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold mb-6 font-merriweather">Radio Groups</h2>
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-lg font-semibold mb-4">Historical Figures</h4>
                <fieldset className="max-w-xs">
                  <legend className="sr-only">Select one historical figure</legend>
                  <RadioGroup defaultValue="sojourner" name="historical-figures-1">
              ...
              <div>
                ...
                <fieldset className="max-w-xs">
                  <legend className="sr-only">Select notification type</legend>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <fieldset className="max-w-md">
                  ...
                  <RadioGroup variant="tiled" defaultValue="passport" name="documents">
              ...
              <div>
                ...
                <fieldset className="max-w-md">
                  ...
                  <RadioGroup variant="tiled" defaultValue="standard" name="service-options">
                    ...
                    <RadioGroupItem value="emergency" disabled>
                      <div>
                        <div className="font-medium">Emergency Processing</div>
                        <div className="text-sm text-gray-60 mt-1">
          ...
          <div>
            ...
            <Card className="max-w-md">
              <CardHeader>
                ...
                <CardDescription>
                  How would you prefer to be contacted about your application?
                </CardDescription>
              </CardHeader>
              <CardContent>
